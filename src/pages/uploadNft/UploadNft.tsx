...
//               <img
//                 className={classes.uploadmiddlelogo}
...
//               <button className={classes.uploadopenbutton} onClick={browseOpen}>
//                 Upload File
//               </button>
//               <h1 className={classes.uploadopentext}>
...
//               <input
//                 className={classes.editorialsInput}
//                 type="text"
//                 placeholder="100"
//               />
//             </div>
...
//               <h1>Royalties</h1>
//               <input
//                 className={classes.royaltiesInput}
//                 type="text"
//                 placeholder="10"
//               />
//             </div>
