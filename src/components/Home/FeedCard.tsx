        ...
        <div className={styles.feedCardWrapper}>
            ...
            <div className={styles.feedCard}>
                <div className={styles.feedCard_header}>
                    ...
                    <div className={styles.feedCard_header_img}><img src={verified}/></div>
                    <div className={styles.feedCard_header_date}>Dec 14</div>
                    <div className={styles.feedCard_header_menu}><img src={menuIcon}/></div>
                </div>
                <div className={styles.feedCard_description}><span>#Bitcoin</span> seems to be doing exactly what its done for about a year. Strong sell-off, consolidate & slow grind up, create a bear flag, RSI breaks down its trend line, bear flag breaks down for another strong sell-off and the cycle begins again.</div>
                <div className={styles.feedCard_image}><img src={post1}/></div>
                <div className={styles.feedCard_buttons}>
                    <button><img src={upvote} alt='vote'/>Upvote</button>
                    <button><img src={chat} alt='comment'/>Comment</button>
